    ...
    def parse_detail_fr_brief(self, item):
        ...
        while True:
            ...
            if html:
                a = pq(html)
                items = a(
                    "div.gallery-section div.gallery-list.clearfix-after div.mixed-list a.photo-container.photo-thumb div.image-thumb")
                for item_sub in items.items():
                    stills.append(item_sub.attr('data-lazy'))

                next_url = a(
                    'body > div.main-wrap > div.width-wrap > main > article > div > div.pager-section > div > ul > li.next > a')
                if next_url:

...
class CWebParserSiteCommon(CWebParserProcess):
    ...
    def parse_detail_fr_brief(self, item):
        ...
        if html:
            ...
            previews = b('div.awe_contentblock_content div.awe_contentblock a')
    ...
    def parse_page(self, url):
        try:
            ...
            if html:
                a = pq(html)
                # items
                items = a('div.awe_contentblock_content div.awe_contentblock a')
                parse_succeed = True
...
def job_start():
    para_args = {
        ...
        'url': 'https://www.dirtyyoungbitches.com/aw/?from={page}',
        'database': 'DirtyYoungBitchesVidoes',
        'start': 0,
        'end': 218
    }
